...
var testContextCleaner = require('./testContextCleaner.js');
var sinon = require('../index.js').sinon;
        ...
        function visit(obj, file, mocha) {
            Object.keys(obj).forEach(function (key) {
                ...
                if (typeof obj[key] === 'function') {
                    ...
                    currentTestCase.beforeEach(function () {
                        testContextCleaner.registerDefaultContextKeys(this);
                    });
                    currentTestCase.afterEach(function () {
                        testContextCleaner.cleanTestContext(this);
                        sinon.restore();
                    });
                    var fn = obj[key].bind(currentTestCase.ctx);
                    switch (key) {
                        case 'setUp':
