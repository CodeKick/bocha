...
export default {
    ...
    elementAttributeEndsWith,
    elementValue,
    elementIsChecked
}

function elementCount(selector, expected, message) {
...
function elementText(selector, expected, message) {
...
function elementTexts(selector, expected, message) {
    let elementTexts = getElementTexts(selector).map(text => text.trim());
    assert.equals(elementTexts, expected, message);
}

function elementTextStartsWith(selector, expected, message) {
    let elementText = getElementText(selector).trim();
...
function elementTextIncludes(selector, expected, message) {
    let elementText = getElementText(selector).trim();
...
function elementTextEndsWith(selector, expected, message) {
    let elementText = getElementText(selector).trim();
...
function elementExactText(selector, expected, message) {
...
function elementHtml(selector, expected, message) {
...
function elementHtmlStartsWith(selector, expected, message) {
    let elementHtml = getElementHtml(selector).trim();
...
function elementHtmlIncludes(selector, expected, message) {
    let elementHtml = getElementHtml(selector).trim();
...
function elementHasClass(selector, expected, message) {
...
function elementStyle(selector, styleProperty, expected, message) {
...
function elementAttribute(selector, attribute, expected, message) {
    let element = getUniqueElement(selector);
...
function elementProperty(selector, property, expected, message) {
    let element = getUniqueElement(selector);
...
function elementAttributeStartsWith(selector, attribute, expected, message) {
    let element = getUniqueElement(selector);
    let actualValue = element.getAttribute(attribute);
...
function elementAttributeEndsWith(selector, attribute, expected, message) {
    let element = getUniqueElement(selector);
    let actualValue = element.getAttribute(attribute);
...
function elementValue(selector, expected, message) {
    let element = getUniqueElement(selector);
...
function elementIsChecked(selector, message) {
    let element = getUniqueElement(selector);
