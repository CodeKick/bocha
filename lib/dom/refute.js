...
import refuteCore from '../refute.js';
import { getElementClasses, getElementCount, getUniqueElement } from './domUtils.js';

export const refute = refuteCore;

refuteCore.elementCount = function elementCount(selector, expected, message) {
...
refuteCore.elementHasClass = function elementHasClass(selector, expected, message) {
...
refuteCore.elementIsChecked = function elementIsChecked(selector, message) {
