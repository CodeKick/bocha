module.exports = function (sinon) {
    ...
    let originalCalledWith = sinon.assert.calledWith;
    sinon.assert.calledWith = function () {
        if (typeof arguments[1] === 'object' && !!arguments[1].test && !!arguments[1].message.includes('match')) {
            return sinon.assert.calledWithMatch.apply(null, Array.prototype.slice.call(arguments));
        }
        return originalCalledWith.apply(null, Array.prototype.slice.call(arguments));
    }
};